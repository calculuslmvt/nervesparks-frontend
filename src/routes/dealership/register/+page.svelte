<script lang="ts">
    ...
    let dealershipEmail = "";
    let password = ""; 
    let dealershipLocation = ""; 
    let isLoading = false; 
    let registerStatus = ""

    const handleRegister = async ()=> {
        isLoading = true; 
        const url = serverUrl + "/dealership/register";
        const payload = {
        ...
        <Sidebar {activeUrl}>
            <SidebarWrapper>
              <SidebarGroup>
                ...
                <Label for="dealership-location" class="block mb-2"></Label>
                <Input id="dealership-location" 
                    size="md" 
                    placeholder="Location" 
                    bind:value={dealershipLocation}/>
                ...
                <SidebarItem 
                label="Log In" href="/dealership/login">
                  <svelte:fragment slot="icon">
